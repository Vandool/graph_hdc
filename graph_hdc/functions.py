...
def register_function(
    ...
    **Example**
    ...
    def decorator(fn: Callable) -> Callable:
        ...
        fn.__function_name__ = name
        fn.__function_desc__ = description
        return fn

    return decorator


def resolve_function(value: Union[str, Callable]) -> Callable:
    """
...
def desolve_function(value: Callable) -> str:
    """
    ...
    return value.__function_name__
