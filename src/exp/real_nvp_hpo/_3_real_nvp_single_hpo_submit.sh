...
DATASET="${DATASET:-QM9_SMILES_HRR_256_F64_G1NG3}"
N_TRIALS="${N_TRIALS:-1}"
...
EXPERIMENTS_PATH="${EXPERIMENTS_PATH:-${PROJECT_DIR}/src/exp/real_nvp_hpo/hpo_single}"
SCRIPT_NAME="${SCRIPT_NAME:-optuna_hpo_single.py}"
