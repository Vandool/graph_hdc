...
GRIDS = list(itertools.product(REC_LEARNING_RATES, REC_ALPHA, REC_LAMBDA_L1, REC_LOW_HIGH_BATCH_SIZE))
...
def experiment(e: Experiment):
    ...
    # GRID SEARCH
    for exp_nr, (lr, alpha, lambda_l1, (low, high, rec_batch_size)) in enumerate(GRIDS):
        e.log(
            f"-------\nNew grid: {exp_nr=}, {e.REC_NUM_ITER=}, {lr=}, {alpha=}, {lambda_l1=}, {low=}, {high=}, {rec_batch_size=}"
        )
