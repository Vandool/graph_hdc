...
PROPERTY="${PROPERTY:-logp}"  # logp, sa_score, qed, max_ring_size
IS_DEV="${IS_DEV:-False}"
...
EXPERIMENTS_PATH="${EXPERIMENTS_PATH:-${PROJECT_DIR}/src/exp/logp_regressor/hpo}"
SCRIPT_NAME="${SCRIPT_NAME:-property_regression_hpo.py}"
SCRIPT="${EXPERIMENTS_PATH}/${SCRIPT_NAME}"
echo "Script  : ${SCRIPT}"

EXP_NAME="Property Regressor ${PROPERTY} ${DATASET}"
