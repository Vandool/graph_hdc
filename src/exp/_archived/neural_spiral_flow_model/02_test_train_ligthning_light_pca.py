...
def run_experiment(cfg: FlowConfig):
    ...
    # Datasets
    train_dataset = ZINC(root=str(global_dataset_dir), pre_transform=AddNodeDegree(), split="train")
    print(f"Train dataset: {len(train_dataset)} samples")
    validation_dataset = ZINC(root=str(global_dataset_dir), pre_transform=AddNodeDegree(), split="val")
