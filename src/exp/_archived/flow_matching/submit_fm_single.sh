#!/bin/bash
#!/usr/bin/env bash
# universal_cluster_submit.sh — Flow Matching Single-Objective HPO
...
EXPERIMENTS_PATH="${EXPERIMENTS_PATH:-${PROJECT_DIR}/src/exp/flow_matching/hpo}"
SCRIPT_NAME="${SCRIPT_NAME:-optuna_hpo_fm_single.py}"
SCRIPT="${EXPERIMENTS_PATH}/${SCRIPT_NAME}"
echo "Script  : ${SCRIPT}"

EXP_NAME="Flow Matching HPO Single ${DATASET} ${NORM_PER}"
