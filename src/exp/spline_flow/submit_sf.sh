...
EXPERIMENTS_PATH="${EXPERIMENTS_PATH:-${PROJECT_DIR}/src/exp/spline_flow/hpo}"
SCRIPT_NAME="${SCRIPT_NAME:-optuna_hpo_sf_composite.py}"
SCRIPT="${EXPERIMENTS_PATH}/${SCRIPT_NAME}"
echo "Script  : ${SCRIPT}"

EXP_NAME="Flow Matching HPO ${DATASET} ${NORM_PER}"
...
case "$CLUSTER" in
  ...
  uc3)
    ...
    TUPLES=$'gpu_h100|12:00:00|128G\ngpu_a100_il|12:00:00|128G\ngpu_h100_il|12:00:00|128G'
    ;;
  hk)
    MODULE_LOAD="module load devel/cuda"
    PIXI_ENV="cluster"
