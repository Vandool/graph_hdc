...
# QED Maximization Final Evaluation Submission Script
# Usage: bash submit_qed_maximization_final.sh <dataset> <model_idx> <hpo_dir>
...
echo "Starting QED Maximization Final Evaluation"
...
SCRIPT_NAME="${SCRIPT_NAME:-eval_qed_maximization_final.py}"
SCRIPT="${EXPERIMENTS_PATH}/${SCRIPT_NAME}"
echo "Script  : ${SCRIPT} ${SELECTION_CRITERION}"

EXP_NAME="QED Max Final ${DATASET} ${SELECTION_CRITERION}"
